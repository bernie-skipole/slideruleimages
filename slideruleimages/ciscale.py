...
def addCIscale(rl, rightmove, zero) -> ET.Element:
    "Adds the CI scale to the rule, returns the scale element"
    ...
    if zero:
        ...
        ciy = "70"
    CImark = ET.SubElement(doc, 'text', {"x":str(rightmove + 8), "y":ciy, "fill":"red", "font-size":"24"})
    CImark.text = "CI"
