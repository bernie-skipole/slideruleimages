...
from .ll03scale import addLL03scale

from .ll02scale import addLL02scale
...
from .sscale import addSscale

from .tscale import addTscale
...
class Rule:
    ...
    def addDIscale(self, btmrule=-1, midrule=-1, toprule=-1):
        self._createscale(addDIscale, btmrule, midrule, toprule)
    ...
    def addLL03scale(self, btmrule=-1, midrule=-1, toprule=-1):
        self._createscale(addLL03scale, btmrule, midrule, toprule)

    def addLL02scale(self, btmrule=-1, midrule=-1, toprule=-1):
        self._createscale(addLL02scale, btmrule, midrule, toprule)
    ...
    def addSscale(self, btmrule=-1, midrule=-1, toprule=-1):
        self._createscale(addSscale, btmrule, midrule, toprule)

    def addTscale(self, btmrule=-1, midrule=-1, toprule=-1):
        self._createscale(addTscale, btmrule, midrule, toprule)
